...
class Config:
    ...
    def load(self) -> None:
        ...
        try:
            ...
            if "adapter" in data:
                ...
                # Ensure proper types with explicit conversion
                adapter_config = {
                    "type": str(adapter_data.get("type") or "ELM327"),
                    "port": str(adapter_data.get("port") or "COM1"),
                    "baudrate": self._safe_int(adapter_data.get("baudrate"), 38400),
                    "timeout": self._safe_float(adapter_data.get("timeout"), 2.0),
                }
            ...
            if "logging" in data:
                ...
                logging_config = {
                    ...
                    "format": str(logging_data.get("format") or default_format),
                    "file": (
                        str(logging_data["file"]) if logging_data.get("file") else None
                    ),
                }
            ...
            if "forscan" in data:
                ...
                forscan_config = {
                    "executable_path": (
                        ...
                        if forscan_data.get("executable_path")
                        else None
                    ),
                    "data_dir": str(forscan_data.get("data_dir") or "./data"),
                    "config_dir": str(forscan_data.get("config_dir") or "./config"),
    ...
    def _safe_int(self, value: str | int | float | bool | None, default: int) -> int:
    ...
    def _safe_float(
        self, value: str | int | float | bool | None, default: float
    ) -> float:
    ...
    def _safe_bool(self, value: str | int | float | bool | None, default: bool) -> bool:
    ...
    def update_adapter_config(self, **kwargs: str | int | float | bool) -> None:
    ...
    def update_forscan_config(self, **kwargs: str | bool | None) -> None:
    ...
    def setup_logging(self) -> None:
        ...
        logging.basicConfig(
            ...
            filename=(
                str(config_args.get("filename")) if "filename" in config_args else None
            ),
        )
